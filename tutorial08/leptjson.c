...
lept_value *lept_insert_array_element(lept_value *v, size_t index) {
     ...
     * 0 1 2 3
     * 0 1 2
     * 1 index =1 size =3 3 -1 ;
     * 0 1  1 2
     * */
    size_t size, capacity;
    size = v->u.a.size;
    capacity = v->u.a.capacity;
    if (size == capacity) lept_reserve_array(v, capacity == 0 ? 1 : (size << 1));
    memcpy(&v->u.a.e[index + 1], &v->u.a.e[index], (size - index) * sizeof(lept_value));
